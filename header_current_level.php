    ...
    <nav class="navbar navbar-light" style="background-color: #acfa9e;">
        ...
        <div class="text-right"
            <?php if(isset($_SESSION['logged_user'])) : ?>
                <a><i class="fa fa-check-square-o label-blue"></i>
...
<body bgcolor="#7fffd4">
    ...
    <div class="ui-94">
        <div class="container">
            ...
            <div class="navigation">
                <div class="row">
                    <?php if($_SESSION['logged_user']->role % 3 == 1 or (int)($_SESSION['logged_user']->role / 3) > 1) : ?>
                    <div class="col-md-3 col-sm-4 col-xs-6 col">
                        <div class="menu">
                            <span class="bg-green"><i class="fa fa-desktop"></i> &nbsp; Администрирование</span>
                            <div class="menu-list">
                                <ul>
                    ...
                    <?php endif; ?>
                    <?php if($_SESSION['logged_user']->role % 2 == 1) : ?>
                    <div class="col-md-3 col-sm-4 col-xs-6 col">
                        <div class="menu">
                            <span class="bg-yellow"><i class="fa fa-desktop"></i> &nbsp; Управление курсами</span>
                            <div class="menu-list">
                                <ul>
                    ...
                    <?php endif; ?>
                    <?php if($_SESSION['logged_user']->role % 3 == 2 or (int)($_SESSION['logged_user']->role / 3) > 1) : ?>
                    <div class="col-md-3 col-sm-4 col-xs-6 col">
                        <div class="menu">
                            <span class="bg-blue"><i class="fa fa-desktop"></i> &nbsp; Мои курсы</span>
                            <div class="menu-list">
                                <ul>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-6 col">
                        <div class="menu">
                            <span class="bg-red"><i class="fa fa-cloud"></i> &nbsp; Личное</span>
                            <div class="menu-list">
                                <ul>
    ...
    <div class="menu-btn">
        <a class="bg-green" href="#">МЕНЮ <i class="fa fa-chevron-down"></i></a>
    </div>
